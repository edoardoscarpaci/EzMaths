...
inline Vec3<T> operator* (const Mat4x3<T>& left, const Vec4<T>& right)
{
	return new Vec3<T>
		(
			left[0][0] * right.x + left[1][0] * right.y + left[2][1] * right.z + left[3][1] * right.w,
			left[0][0] * right.x + left[1][1] * right.y + left[2][1] * right.z + left[3][1] * right.w,
			left[0][0] * right.x + left[1][2] * right.y + left[2][2] * right.z + left[3][2] * right.w
...
inline Mat4x4<T> operator* (const Mat3x4<T>& left, const Mat4x3<T>& right)
{
	return new Mat4x4<T>
		(
			...
			left[0][1] * right[0][0] + left[1][1] * right[0][1] + left[2][1] * right[0][2],
			left[0][2] * right[0][0] + left[1][2] * right[0][1] + left[2][2] * right[0][2],
			left[0][3] * right[0][0] + left[1][3] * right[0][1] + left[3][2] * right[0][2],
